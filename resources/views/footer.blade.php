        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-3 col-md-6">
                    <h1 class="fw-bold text-primary mb-4">Org<span class="text-white">Profile</span></h1>
                ...
                <div class="col-lg-3 col-md-6">
                    <h5 class="text-light mb-4">{{__('trans.Address')}}</h5>
                    <p><i class="fa fa-map-marker-alt me-3"></i>{{__('trans.location')}}</p>
                    <p><i class="fa fa-phone-alt me-3"></i>+012 345 67890</p>
                    <p><i class="fa fa-envelope me-3"></i>info@example.com</p>
                </div>
                <div class="col-lg-3 col-md-6">
                    <h5 class="text-light mb-4">{{__('trans.Quick Links')}}</h5>
                ...
                <div class="col-lg-3 col-md-6">
                    <h5 class="text-light mb-4">{{__('trans.Newsletter')}}</h5>
